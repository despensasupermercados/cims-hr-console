...
export const MARIA_TOOLS = [
  ...
  { name: "find_crew", description: "Look up crew by name (partial OK). Returns each match's status, vessel, rank, contract count, and document expiry dates. Use for questions about a specific person.", input_schema: { type: "object", properties: { name: { type: "string", description: "Full or partial crew name" } }, required: ["name"], additionalProperties: false } },
